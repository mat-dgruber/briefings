...
@Component({
  ...
  template: `
    <div class="text-center max-w-2xl mx-auto flex flex-col items-center">
      ...
      <div
        class="w-24 h-24 bg-netflix-red rounded-full flex items-center justify-center mb-8 animate-bounce"
      >
        <svg
      ...
      <p class="text-soft-gray text-xl mb-12 leading-relaxed">
        Obrigado por compartilhar sua visão. Analisarei os detalhes e entrarei em contato em até 24
        horas para agendarmos nossa primeira reunião técnica.
      </p>

      <div
        class="bg-white bg-opacity-5 p-8 rounded-lg border border-white border-opacity-10 w-full mb-12"
      >
        <h2 class="text-lg font-bold mb-4 uppercase tracking-widest text-netflix-red">
          Próximos Passos
        </h2>
